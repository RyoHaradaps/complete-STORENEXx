...
export default {
  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        input: "hsl(var(--input))",
        ring: "hsl(var(--ring))",
        background: "hsl(var(--background))", // Registers the background color
        foreground: "hsl(var(--foreground))", // Registers the foreground color
        primary: {
  ...
  plugins: [require("tailwindcss-animate")], // Includes the animate plugin
} satisfies Config;